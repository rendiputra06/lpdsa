...
import { Save, Calendar, FileText, Tag, Settings, ImageIcon, MapPin, User, Users, LinkIcon, X } from 'lucide-react';
import type { AnnouncementCategory, AnnouncementFormData } from '@/types/announcement';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            name="content"
                            rows={12}
                            className={`w-full rounded-md border bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 resize-y ${errors.content ? 'border-red-500 focus-visible:ring-red-500' : 'border-input focus-visible:ring-ring'}`}
                            value={data.content}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Atur status dan media pengumuman</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                    ...
                    <div className="space-y-3">
                        ...
                        {thumbnailUrl && (
                            <div className="relative w-full max-w-xs rounded-lg overflow-hidden border group">
                                <img
                        ...
                        <Input
                            ...
                            className="file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-univrab-blue/10 file:text-univrab-blue hover:file:bg-univrab-blue/20"
                        />
                        <p className="text-xs text-muted-foreground">Maksimal 2MB. Format: JPG, PNG, GIF</p>
